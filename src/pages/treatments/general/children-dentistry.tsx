  ...
  const process = [
    {
      ...
      description: "Child-friendly welcome to help your little one feel comfortable and safe"
    },
    {
      step: "2",
      title: "Gentle Examination",
      description: "Thorough but gentle examination of teeth, gums, and oral development"
    },
    {
      step: "3",
      title: "Cleaning & Prevention",
      description: "Professional cleaning and preventive treatments like fluoride or sealants"
    },
    {
      step: "4",
      title: "Education & Fun",
      description: "Teaching proper brushing and flossing in a fun, engaging way"
    },
    {
      step: "5",
      title: "Parent Consultation",
      description: "Discussion with parents about home care and future dental needs"
    }
  ];
...
export default ChildrenDentistryPage;