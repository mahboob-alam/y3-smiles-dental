...
export const Head = () => (
  <SEO 
    title="Craigieburn | Y3 Smiles Dental"
                        ...
                        <div className="max-w-5xl mx-auto">
                            <div className="text-center mb-12">
                                <div className="inline-flex items-center justify-center mb-8 p-4 bg-white/90 backdrop-blur-sm rounded-2xl shadow-soft">
                                    ...
                                    <div className="text-left">
                                        <p className="text-sm font-medium text-primary uppercase tracking-wider">Craigieburn Dentists</p>
                                        <p className="text-lg font-bold text-neutral-800">Craigieburn</p>
                                    </div>
                                </div>
                                ...
                                <p className="text-xl text-neutral-800 mb-12 leading-relaxed max-w-3xl mx-auto">
                                    Experience exceptional dental care at Craigieburn Dental Clinic. Our state-of-the-art clinic
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
                                <div className="flex items-center bg-white/90 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-soft hover:shadow-medium transition-all duration-300 group">
                                    ...
                                    <span className="font-semibold text-neutral-800">Local Craigieburn Clinic</span>
                                </div>
                                <div className="flex items-center bg-white/90 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-soft hover:shadow-medium transition-all duration-300 group">
                        ...
                        <div className="max-w-7xl mx-auto">
                            <div className="text-center mb-20">
                                ...
                                <p className="text-xl text-neutral-800 max-w-4xl mx-auto leading-relaxed">
                                    ...
                                    make for Craigieburn families. Here's what sets us apart.
                                </p>
                            </div>
                        ...
                        <div className="max-w-7xl mx-auto">
                            <div className="text-center mb-20">
                                ...
                                <h2 className="text-4xl md:text-5xl font-bold text-neutral-800 mb-6 leading-tight">
                                    ...
                                    <span className="block text-primary">Craigieburn</span>
                                </h2>
