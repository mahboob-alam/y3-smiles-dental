...
const DentalFillingsPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Contact us immediately for an emergency appointment. Avoid chewing on that side, keep the area clean, and save the filling if possible. We can often replace it the same day."
    },
    {
      question: "How can I prevent needing fillings?",
      answer: "Good oral hygiene, regular dental visits, limiting sugary foods, using fluoride toothpaste, and considering dental sealants are the best ways to prevent cavities."
    }
  ];
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="text-center">
                  ...
                  <div className="text-neutral-600">Fillings Placed</div>
                </div>
                <div className="text-center">
