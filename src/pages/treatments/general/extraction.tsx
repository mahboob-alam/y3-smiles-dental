...
const ExtractionPage = () => {
  ...
  const faqs = [
    ...
    {
      question: "What are the risks of tooth extraction?",
      answer: "Extraction is generally safe, but risks include dry socket, infection, nerve damage, or sinus complications (for upper teeth). Following post-operative instructions minimizes these risks."
    },
    {
      question: "Can I drive home after an extraction?",
      answer: "If you receive only local anesthesia, you can drive home. However, if you receive sedation, you'll need someone to drive you home and stay with you for a few hours."
    }
  ];
                ...
                <Card key={index} className="border-0 shadow-soft hover:shadow-medium transition-smooth">
                  ...
                  <CardContent>
                    <ul className="space-y-3">
                      {period.instructions.map((instruction, instructionIndex) => (
                        <li key={instructionIndex} className="flex items-start text-sm text-neutral-600">
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">
                Don't leave empty spaces - explore options to replace extracted teeth.
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="text-center">
                  ...
                  <div className="text-neutral-600">Minutes Procedure</div>
                </div>
                <div className="text-center">
