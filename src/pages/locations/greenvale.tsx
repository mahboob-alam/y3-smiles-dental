                    ...
                    <div className="container mx-auto px-6">
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="text-4xl font-bold text-neutral-800 mb-12">
                                Convenient Location for Greenvale Residents
                            </h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                                <div className="bg-white p-6 rounded-2xl shadow-soft">
                                    ...
                                    <p className="text-neutral-600 text-sm">
                                        ...
                                        <span className="text-primary font-medium">Serving Greenvale</span>
                                    </p>
                                </div>
                            ...
                            <div className="bg-neutral-100 rounded-2xl p-12 mb-8">
                                ...
                                <p className="text-neutral-600">
                                    Interactive map highlighting Greenvale area would be displayed here
                                </p>
                            </div>
