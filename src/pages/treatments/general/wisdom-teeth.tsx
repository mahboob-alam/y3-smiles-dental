...
const WisdomTeethPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Stick to soft foods like yogurt, soup, smoothies, and mashed potatoes for the first few days. Gradually introduce firmer foods as healing progresses."
    },
    {
      question: "What are the risks of wisdom tooth removal?",
      answer: "Risks are minimal but may include dry socket, infection, nerve damage, or sinus complications. Following post-operative instructions significantly reduces these risks."
    }
  ];
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-lg text-neutral-600 mb-8 leading-relaxed">
                    Wisdom teeth, or third molars, often lack sufficient space to erupt properly 
                    in modern jaws. This can lead to impaction, crowding, decay, and gum disease. 
                    Preventive removal in the late teens or early twenties can avoid these complications 
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="font-semibold text-neutral-800 mb-1">Prevent Crowding</h4>
                        <p className="text-neutral-600 text-sm">Avoid shifting of previously straightened teeth</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-primary mr-3 mt-1 flex-shrink-0" />
                      <div>
                        <h4 className="font-semibold text-neutral-800 mb-1">Easier Cleaning</h4>
                        <p className="text-neutral-600 text-sm">Improve access for proper oral hygiene</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-primary mr-3 mt-1 flex-shrink-0" />
                      <div>
                        <h4 className="font-semibold text-neutral-800 mb-1">Avoid Complications</h4>
                        <p className="text-neutral-600 text-sm">Prevent cysts, infections, and damage to adjacent teeth</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="aspect-video bg-neutral-100 rounded-2xl overflow-hidden">
                  <img 
                    src="https://images.pexels.com/photos/6812544/pexels-photo-6812544.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop"
                    alt="Wisdom tooth removal procedure showing professional oral surgery"
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">
                The timing of wisdom tooth removal can significantly impact the procedure and recovery.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {ageConsiderations.map((age, index) => (
                <Card key={index} className="border-0 shadow-soft hover:shadow-medium transition-smooth">
                  ...
                  <CardContent>
                    <ul className="space-y-2">
                      {age.advantages.map((advantage, advantageIndex) => (
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="text-center">
                  ...
                  <div className="text-neutral-600">Need Removal</div>
                </div>
                <div className="text-center">
                  <Clock className="w-12 h-12 text-primary mx-auto mb-4" />
                  <div className="text-4xl font-bold text-primary mb-2">17-25</div>
                  <div className="text-neutral-600">Ideal Age Range</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-neutral-600">Extractions Performed</div>
                </div>
              </div>
            </div>
          </div>
