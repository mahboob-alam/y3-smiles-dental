...
export const Head = () => (
  <SEO 
    title="Campbellfield | Y3 Smiles Dental"
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-grow">
                        ...
                        <div className="max-w-5xl mx-auto">
                            <div className="text-center mb-12">
                                <div className="inline-flex items-center justify-center mb-8 p-4 bg-white/90 backdrop-blur-sm rounded-2xl shadow-soft">
                                    ...
                                    <div className="text-left">
                                        <p className="text-sm font-medium text-primary uppercase tracking-wider">Campbellfield Dentists</p>
                                        <p className="text-lg font-bold text-neutral-800">Campbellfield</p>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
                                <div className="flex items-center bg-white/90 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-soft hover:shadow-medium transition-all duration-300 group">
                                    ...
                                    <span className="font-semibold text-neutral-800">Local Campbellfield Clinic</span>
                                </div>
                                <div className="flex items-center bg-white/90 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-soft hover:shadow-medium transition-all duration-300 group">
                                    ...
                                    <div className="space-y-6">
                                        <div className="bg-white p-6 rounded-2xl shadow-soft border-l-4 border-primary">
                                            <p className="text-lg text-neutral-700 leading-relaxed">
                                                At Y3 Smiles Dental near Campbellfield, we believe good dental care is more than just brushing
                                ...
                                <div className="relative">
                                    ...
                                    <div className="relative bg-white p-2 rounded-3xl shadow-2xl">
                                        <div className="aspect-[4/3] bg-neutral-100 rounded-2xl overflow-hidden">
                                            <img
                                                src="/campbellfield.png"
                                                alt="Modern dental office in Campbellfield"
                        ...
                        <div className="max-w-7xl mx-auto">
                            <div className="text-center mb-20">
                                ...
                                <p className="text-xl text-neutral-800 max-w-4xl mx-auto leading-relaxed">
                                    ...
                                    make for Campbellfield families. Here's what sets us apart.
                                </p>
                            </div>
                        ...
                        <div className="max-w-7xl mx-auto">
                            <div className="text-center mb-20">
                                ...
                                <h2 className="text-4xl md:text-5xl font-bold text-neutral-800 mb-6 leading-tight">
                                    ...
                                    <span className="block text-primary">Campbellfield</span>
                                </h2>
                ...
                <GoogleMap
                    locationName="Campbellfield"
                    locationData={locationConfigs.campbellfield.locationData}
                    openingHours={locationConfigs.campbellfield.openingHours}
